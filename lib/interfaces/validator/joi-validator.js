...
const schema = Joi.object({
    ...
    fields: Joi.array().items(Joi.string().valid('source', 'source_id', 'results_available', 'review_status', 'ipd_sharing',
...
/**
 * Joi Validator used to validate the payload - and in this case the query parameters
 */
